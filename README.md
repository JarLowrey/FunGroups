<h1>Fun Groups</h1>
<p>This project was my first stab at Android programming. The purpose was to create a studying tool for O. Chem. functional groups (http://en.wikipedia.org/wiki/Functional_group) </p></br>
